...
function searchCity(cityname) {
    ...
    var queryURL = "https://api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}" + cityname + "&appid=b218b877a4fe40687eb5f071afb6252a";
    var queryURLforcast = "https://api.openweathermap.org/data/2.5/forecast?lat={lat}&lon={lon}" + cityname + "&appid=b218b877a4fe40687eb5f071afb6252a";
...
var queryURLUV = "https://api.openweathermap.org/data/2.5/uvi?&appid=b218b877a4fe40687eb5f071afb6252a&lat=" + lat  + "&lon=" + lon;
...
//Event deligation...
$("#today").on('click', '.btn', function(event) {
event.preventDefault();
